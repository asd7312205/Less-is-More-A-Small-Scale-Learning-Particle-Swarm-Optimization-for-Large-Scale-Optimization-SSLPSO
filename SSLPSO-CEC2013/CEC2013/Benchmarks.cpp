...
string path="/home/liu/testSetFile/CEC2013/";
...
double* Benchmarks::readOvector()
{
  ...
  stringstream ss;
  ss<<path<< "cdatafiles/" << "F" << ID << "-xopt.txt";
...
double** Benchmarks::readR(int sub_dim)
{
  ...
  stringstream ss;
  ss<<path<< "cdatafiles/" << "F" << ID << "-R"<<sub_dim<<".txt";
  // cout<<ss.str()<<endl;
